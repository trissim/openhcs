...
RESIZE_OBJECTS_SETTINGS: tuple[SettingToKeywordBinding, ...] = (
    ...
    SettingToKeywordBinding(RESIZE_OBJECTS_FACTOR_Z_SETTING, "factor_z", parse_cellprofiler_float),
    ...
    SettingToKeywordBinding(RESIZE_OBJECTS_PLANES_SETTING, "planes", parse_cellprofiler_int),
)
