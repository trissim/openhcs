...
England's 2013 result is a stochastic-thermodynamic path-space theorem with detailed balance and far-from-equilibrium dynamics \cite{england2013statistical}. The replication theorem in this paper is a finite Landauer-counting statement for the calibrated exact-resolution model. The common term is the multiplicity penalty $k_B \ln k$.
