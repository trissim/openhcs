...
\begin{tikzpicture}[scale=0.85]
  ...
  \begin{scope}[xshift=0cm, yshift=-0.5cm]
    ...
    \node[text width=3.5cm, align=center] at (1.5, -2.0) {\small Every state confusable\\with every other};
  \end{scope}
  ...
  \begin{scope}[xshift=6cm, yshift=-0.5cm]
    ...
    \node[text width=3.5cm, align=center] at (1.5, -2.0) {\small Some pairs distinguishable\\requires only 2 tags};
  \end{scope}
\end{tikzpicture}
