...
\medskip
\noindent\textbf{Remark.} Equivalently, structural integrity (Definition~\ref{def:structural-integrity}) holds if and only if the independent rate equals $1$.\leanmeta{\LHrng{COH}{1}{2}}
...
The surviving ambiguity also forces an information-theoretic lower bound: exact resolution of a $k$-way class requires at least $\log_2 k$ bits of side information (Theorem~\ref{thm:fano-converse} below).\leanmeta{\LH{CIA1}}
