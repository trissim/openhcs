...
Section~\ref{sec:foundations} identifies the unit-rate threshold corollary. This section records two direct interpretations: derivation realizes the unit-rate case, and leaving that case produces the manual-update gap proved later in Section~\ref{sec:rate-corollaries}.
