...
\begin{proof}
Pair injectivity is the structural core. The other theorems express this same injectivity requirement in different coordinates: combinatorial (confusability, counting), source-mass (conditional-entropy, weighted-entropy), and deterministic coarsening with finite alphabet ceilings (decoder-output, gap).
\end{proof}
