\section{Realizability Requirements for the Capacity-Achieving Regime}\label{sec:requirements}
%==============================================================================
...
An encoding system has \emph{causal update propagation} if every update to a source location automatically updates each location derived from that source, without requiring a separate manual synchronization step.
\end{definition}
