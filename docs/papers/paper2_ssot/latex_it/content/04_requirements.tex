...
An encoding system can achieve verifiable independent rate $1$, equivalently verifiable structural integrity, for structural facts if and only if it provides both causal update propagation and provenance observability.
\end{corollary}
