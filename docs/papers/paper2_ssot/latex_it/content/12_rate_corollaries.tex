...
The zero-incoherence threshold also has a cost consequence: independent rate governs manual synchronization cost in the same finite deterministic model.
