...
The asymptotic scaffold is also no longer limited to a lower envelope statement. On the graph side itself, the mechanized development now proves strong-product lower bounds for independent-set cardinality and the induced monotonicity of normalized strong-power rates along repeated multiples. Specializing those generic graph theorems back to the SSOT confusability graph yields the repeated-block statement below.\leanmeta{\LHrng{MFT}{40}{42}}
