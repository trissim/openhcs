...
\ifdefined\ITSUBMISSION
  ...
  \begin{tikzpicture}
    ...
    \begin{scope}[xshift=6.5cm, yshift=-1.2cm]
      ...
      \node[text width=4.3cm, align=center] at (1.5, -1.3) {\small Some pairs distinguishable\\requires only 2 tags};
    \end{scope}
  \end{tikzpicture}%
  }%
\else
...
\leanmeta{\LHrng{MFT}{25}{26}, \LHrng{MFT}{29}{30}, \LHrng{MFT}{38}{39}}
