...
The theorem formalizes a basic fact about open-world systems: present collision-freedom does not by itself yield a stable future guarantee. In applications where correctness depends on persistent zero-error identification, extension-stability must be proved under an explicit growth model rather than inferred from the current snapshot alone.
\end{remark}
