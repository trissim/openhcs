...
abbrev FR319 := @TransportedOutputClosureSpec.classifier_agrees_on_closureEquivalent_of_correctOnDomain
abbrev FR320 := @TransportedOutputClosureSpec.no_correctOnDomain_classifier_of_orbit_gap
abbrev FR321 := @IdentityOutputClosureSpec.correctOnDomain_iff_correctOnDomain_transport
abbrev FR322 := @representationRelativeHypothesis_classifier_agrees_on_closureEquivalent_of_correctOnDomain
abbrev FR323 := @representationRelativeEstimator_classifier_agrees_on_closureEquivalent_of_correctOnDomain
abbrev FR324 := @representationRelativePolicy_classifier_agrees_on_closureEquivalent_of_correctOnDomain
abbrev FR325 := @representationRelativeRandomizedProcedure_classifier_agrees_on_closureEquivalent_of_correctOnDomain
abbrev FR326 := @no_correctOnDomain_representationRelativeHypothesis_classifier_of_orbit_gap
abbrev FR327 := @no_correctOnDomain_representationRelativeEstimator_classifier_of_orbit_gap
abbrev FR328 := @no_correctOnDomain_representationRelativePolicy_classifier_of_orbit_gap
abbrev FR329 := @no_correctOnDomain_representationRelativeRandomizedProcedure_classifier_of_orbit_gap
