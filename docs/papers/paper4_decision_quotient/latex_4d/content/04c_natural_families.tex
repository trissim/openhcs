...
\leanmetapending{\LH{FR263}}
\begin{proposition}[Approximate Relevance Claims Need Explicit Stability Control]\label{prop:approximate-relevance-needs-stability-control}
...
Thus closeness alone does not justify an approximate relevance claim. Any $\varepsilon$-based relevance claim needs an explicit reduction to the exact optimizer sets, for example by a witness-gap bound as in Proposition~\ref{prop:approximate-relevance-needs-stability-control}, because otherwise arbitrarily small perturbations can change the exact relevance judgment.
