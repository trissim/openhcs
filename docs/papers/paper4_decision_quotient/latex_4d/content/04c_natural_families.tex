...
Any output specification is in scope once written as a state-indexed admissible-output relation. This includes decision, counting, search, approximation guarantees, distributional specifications, and any other specification stated by the outputs that count as correct at each state.
