...
The artifact also contains the remaining canonical compute-cost instantiations. The same closure-law-invariance statement is formalized for deterministic optimizer-set payload output and admissible-output search on optimizer-set semantics. Thus the forced-invariance argument applies not only to exact-certification predicates, but also to these canonical output-production tasks.\leanmeta{\LHrng{FR}{245}{249}}
