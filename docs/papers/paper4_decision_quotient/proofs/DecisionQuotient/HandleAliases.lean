...
abbrev CP2 := @Tractability.CertifiedPruning.certificate_of_exact_top1
abbrev CP3 := @Tractability.CertifiedPruning.certificate_of_top1_branch
abbrev CP4 := @Tractability.CertifiedPruning.certifiedSurvivorSet_of_exact_top1
abbrev CP5 := @Tractability.CertifiedPruning.certifiedSurvivorSet_of_top1_coarse_ambiguityBand
abbrev CP6 := @Tractability.CertifiedPruning.certifiedSurvivorSet_of_exact_singleton_winner
...
abbrev FLO11 := @Tractability.FormalLocalOptimizer.selectionWitness_of_ambiguityBand
abbrev FLO12 := @Tractability.FormalLocalOptimizer.selectionWitness_of_supportSet
abbrev FLO13 := @Tractability.FormalLocalOptimizer.beliefWitness_of_survivorConditioning_ambiguityBand
abbrev FLO14 := @Tractability.FormalLocalOptimizer.beliefWitness_of_survivorConditioning_supportSet
abbrev FLO15 := @Tractability.FormalLocalOptimizer.optimizerWitness_of_exact_top1
abbrev FLO16 := @Tractability.FormalLocalOptimizer.optimizerWitness_of_top1_coarse_ambiguityBand
abbrev FLO17 := @Tractability.FormalLocalOptimizer.optimizerWitness_of_exact_singleton_winner
abbrev FLO18 := @Tractability.FormalLocalOptimizer.optimizerWitness_of_top1_branch
