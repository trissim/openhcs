...
`Physics.InvariantAgreement.IA17_observer_level_rejection_cascade`
...
| :::             |                                                                                                     | :::             |                                                                                                        |
+-----------------+-----------------------------------------------------------------------------------------------------+-----------------+--------------------------------------------------------------------------------------------------------+
| ::: {#lh:IA17}  | `Physics.InvariantAgreement.IA17_observer_level_rejection_cascade`                               | ::: {#lh:IA18}  | `Physics.InvariantAgreement.IA18_escalation_complete`                                                  |
| `IA17`          |                                                                                                     | `IA18`          |                                                                                                        |
| :::             |                                                                                                     | :::             |                                                                                                        |
+-----------------+-----------------------------------------------------------------------------------------------------+-----------------+--------------------------------------------------------------------------------------------------------+
...
-   `BF4` $\to$ `DQ.bayes_update_exists_of_nondegenerateBelief`
  ...
  **Paper handle**                                **Status**   **Lean support**
  ...
  `cor:observer-rejection-cascade`                Full         `P.InvariantAgreement.IA18_escalation_complete`
...
*Auto summary: mapped 226/226 (full=226, derived=0, unmapped=0).*
  ...
  **Paper handle**                                **Hardness profile**     **Regime tags**                                 **Lean support**
  ...
  `cor:observer-rejection-cascade`                `unspecified`            \-                                              IA18
