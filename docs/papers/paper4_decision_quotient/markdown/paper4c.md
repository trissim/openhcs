...
**Status**: ITP/CPP-ready | **Lean**: 72512 lines, 3086 theorems
...
The complete Lean 4 formalization is available in the companion artifact (Zenodo DOI listed on the title page). The mechanization consists of 72512 lines across 285 files, with 3086 theorem/lemma statements.
...
| :::             |                                                                                                        | :::             |                                                                                                     |
+-----------------+--------------------------------------------------------------------------------------------------------+-----------------+-----------------------------------------------------------------------------------------------------+
| ::: {#lh:CC33}  | `DecisionQuotient.ClaimClosure.integrity_universal_applicability_core`                                 | ::: {#lh:CC36}  | `DecisionQuotient.ClaimClosure.minsuff_collapse_core`                                               |
| `CC33`          |                                                                                                        | `CC36`          |                                                                                                     |
| :::             |                                                                                                        | :::             |                                                                                                     |
+-----------------+--------------------------------------------------------------------------------------------------------+-----------------+-----------------------------------------------------------------------------------------------------+
...
| :::             |                                                                                                        | :::             |                                                                                                     |
+-----------------+--------------------------------------------------------------------------------------------------------+-----------------+-----------------------------------------------------------------------------------------------------+
| ::: {#lh:IV9}   | `DecisionQuotient.InteriorVerification.interior_verification_tractable_certificate`                    | ::: {#lh:L8}    | `exists_orthogonal_semanticallyMinimal_subset`                                                      |
| `IV9`           |                                                                                                        | `L8`            |                                                                                                     |
| :::             |                                                                                                        | :::             |                                                                                                     |
+-----------------+--------------------------------------------------------------------------------------------------------+-----------------+-----------------------------------------------------------------------------------------------------+
...
| :::             |                                                                                                        | :::             |                                                                                                     |
+-----------------+--------------------------------------------------------------------------------------------------------+-----------------+-----------------------------------------------------------------------------------------------------+
| ::: {#lh:SR5}   | `ClaimClosure.SR5`                                                                                     | ::: {#lh:TUR1}  | `Physics.transitionProb_nonneg`                                                                     |
| `SR5`           |                                                                                                        | `TUR1`          |                                                                                                     |
| :::             |                                                                                                        | :::             |                                                                                                     |
+-----------------+--------------------------------------------------------------------------------------------------------+-----------------+-----------------------------------------------------------------------------------------------------+
| ::: {#lh:TUR2}  | `Physics.transitionProb_sum_one`                                                                       | ::: {#lh:TUR5}  | `Physics.tur_bridge`                                                                                |
| `TUR2`          |                                                                                                        | `TUR5`          |                                                                                                     |
| :::             |                                                                                                        | :::             |                                                                                                     |
+-----------------+--------------------------------------------------------------------------------------------------------+-----------------+-----------------------------------------------------------------------------------------------------+
| ::: {#lh:TUR6}  | `Physics.multiple_futures_entropy_production`                                                          | ::: {#lh:W1}    | `Physics.single_future_zero_cost`                                                                   |
| `TUR6`          |                                                                                                        | `W1`            |                                                                                                     |
| :::             |                                                                                                        | :::             |                                                                                                     |
+-----------------+--------------------------------------------------------------------------------------------------------+-----------------+-----------------------------------------------------------------------------------------------------+
| ::: {#lh:W2}    | `Physics.transportCost_pos_of_offDiag`                                                                 | ::: {#lh:W3}    | `Physics.integrity_is_centroid`                                                                     |
| `W2`            |                                                                                                        | `W3`            |                                                                                                     |
| :::             |                                                                                                        | :::             |                                                                                                     |
+-----------------+--------------------------------------------------------------------------------------------------------+-----------------+-----------------------------------------------------------------------------------------------------+
| ::: {#lh:W4}    | `Physics.wasserstein_bridge`                                                                           | ::: {#lh:WC1}   | `Physics.WolpertConstraints.landauer_floor_plus_overhead_lower_bound`                               |
| `W4`            |                                                                                                        | `WC1`           |                                                                                                     |
| :::             |                                                                                                        | :::             |                                                                                                     |
+-----------------+--------------------------------------------------------------------------------------------------------+-----------------+-----------------------------------------------------------------------------------------------------+
| ::: {#lh:WC2}   | `Physics.WolpertConstraints.effective_model_dominates_landauer_floor`                                  | ::: {#lh:WC3}   | `Physics.WolpertConstraints.effective_model_strictly_exceeds_landauer_of_strict_overhead`           |
| `WC2`           |                                                                                                        | `WC3`           |                                                                                                     |
| :::             |                                                                                                        | :::             |                                                                                                     |
+-----------------+--------------------------------------------------------------------------------------------------------+-----------------+-----------------------------------------------------------------------------------------------------+
| ::: {#lh:WC4}   | `Physics.WolpertConstraints.energy_lower_bound_mono_under_overhead`                                    | ::: {#lh:WC5}   | `Physics.WolpertConstraints.physical_grounding_bundle_with_wolpert_overhead`                        |
| `WC4`           |                                                                                                        | `WC5`           |                                                                                                     |
| :::             |                                                                                                        | :::             |                                                                                                     |
+-----------------+--------------------------------------------------------------------------------------------------------+-----------------+-----------------------------------------------------------------------------------------------------+
...
| :::             |                                                                                                        | :::             |                                                                                                     |
+-----------------+--------------------------------------------------------------------------------------------------------+-----------------+-----------------------------------------------------------------------------------------------------+
| ::: {#lh:WD3}   | `DecisionQuotient.checking_time_ge_witness_budget`                                                     | ::: {#lh:WD4}   | `DecisionQuotient.witnessBudgetEmpty`                                                               |
| `WD3`           |                                                                                                        | `WD4`           |                                                                                                     |
| :::             |                                                                                                        | :::             |                                                                                                     |
+-----------------+--------------------------------------------------------------------------------------------------------+-----------------+-----------------------------------------------------------------------------------------------------+
| ::: {#lh:WD5}   | `DecisionQuotient.checkingBudgetPairs`                                                                 | ::: {#lh:WM1}   | `Physics.WolpertMismatch.mismatchKL_nonneg`                                                         |
| `WD5`           |                                                                                                        | `WM1`           |                                                                                                     |
| :::             |                                                                                                        | :::             |                                                                                                     |
+-----------------+--------------------------------------------------------------------------------------------------------+-----------------+-----------------------------------------------------------------------------------------------------+
| ::: {#lh:WM2}   | `Physics.WolpertMismatch.mismatchKL_eq_zero_iff_eq`                                                    | ::: {#lh:WM3}   | `Physics.WolpertMismatch.mismatchKL_pos_of_exists_ne`                                               |
| `WM2`           |                                                                                                        | `WM3`           |                                                                                                     |
| :::             |                                                                                                        | :::             |                                                                                                     |
+-----------------+--------------------------------------------------------------------------------------------------------+-----------------+-----------------------------------------------------------------------------------------------------+
| ::: {#lh:WM4}   | `Physics.WolpertMismatch.mismatchNatLowerBound_pos_of_exists_ne`                                       | ::: {#lh:WM5}   | `Physics.WolpertDecomposition.periodic_modular_mismatch_of_distribution_mismatch`                   |
| `WM4`           |                                                                                                        | `WM5`           |                                                                                                     |
| :::             |                                                                                                        | :::             |                                                                                                     |
+-----------------+--------------------------------------------------------------------------------------------------------+-----------------+-----------------------------------------------------------------------------------------------------+
| ::: {#lh:WM6}   | `Physics.WolpertDecomposition.effective_model_strictly_exceeds_landauer_of_distribution_mismatch`      | ::: {#lh:WP1}   | `Physics.WolpertDecomposition.DecomposedProcessModel.totalOverheadPerBit_eq_sum`                    |
| `WM6`           |                                                                                                        | `WP1`           |                                                                                                     |
| :::             |                                                                                                        | :::             |                                                                                                     |
+-----------------+--------------------------------------------------------------------------------------------------------+-----------------+-----------------------------------------------------------------------------------------------------+
| ::: {#lh:WP2}   | `Physics.WolpertDecomposition.landauer_floor_plus_decomposition_lower_bound`                           | ::: {#lh:WP3}   | `Physics.WolpertDecomposition.effective_model_dominates_landauer_floor_decomposition`               |
| `WP2`           |                                                                                                        | `WP3`           |                                                                                                     |
| :::             |                                                                                                        | :::             |                                                                                                     |
+-----------------+--------------------------------------------------------------------------------------------------------+-----------------+-----------------------------------------------------------------------------------------------------+
| ::: {#lh:WP5}   | `Physics.WolpertDecomposition.effective_model_strictly_exceeds_landauer_of_stopping_time_residual`     | ::: {#lh:WP6}   | `Physics.WolpertDecomposition.effective_model_strictly_exceeds_landauer_of_either_cited_component`  |
| `WP5`           |                                                                                                        | `WP6`           |                                                                                                     |
| :::             |                                                                                                        | :::             |                                                                                                     |
+-----------------+--------------------------------------------------------------------------------------------------------+-----------------+-----------------------------------------------------------------------------------------------------+
| ::: {#lh:WP7}   | `Physics.WolpertDecomposition.landauer_floor_plus_structural_resource_lower_bound`                     | ::: {#lh:WP8}   | `Physics.WolpertDecomposition.energy_lower_bound_increases_by_structural_resource`                  |
| `WP7`           |                                                                                                        | `WP8`           |                                                                                                     |
| :::             |                                                                                                        | :::             |                                                                                                     |
+-----------------+--------------------------------------------------------------------------------------------------------+-----------------+-----------------------------------------------------------------------------------------------------+
| ::: {#lh:WP9}   | `Physics.WolpertDecomposition.physical_grounding_bundle_with_wolpert_decomposition`                    | ::: {#lh:WR1}   | `Physics.WolpertResidual.pairwiseResidualKL_nonneg`                                                 |
| `WP9`           |                                                                                                        | `WR1`           |                                                                                                     |
| :::             |                                                                                                        | :::             |                                                                                                     |
+-----------------+--------------------------------------------------------------------------------------------------------+-----------------+-----------------------------------------------------------------------------------------------------+
| ::: {#lh:WR2}   | `Physics.WolpertResidual.pairwiseResidualKL_pos_of_asymmetry`                                          | ::: {#lh:WR3}   | `Physics.WolpertResidual.residualNatLowerBound_pos_of_asymmetry`                                    |
| `WR2`           |                                                                                                        | `WR3`           |                                                                                                     |
| :::             |                                                                                                        | :::             |                                                                                                     |
+-----------------+--------------------------------------------------------------------------------------------------------+-----------------+-----------------------------------------------------------------------------------------------------+
| ::: {#lh:WR4}   | `Physics.WolpertDecomposition.stopping_time_residual_of_pairwise_flow_asymmetry`                       | ::: {#lh:WR5}   | `Physics.WolpertDecomposition.effective_model_strictly_exceeds_landauer_of_pairwise_flow_asymmetry` |
| `WR4`           |                                                                                                        | `WR5`           |                                                                                                     |
| :::             |                                                                                                        | :::             |                                                                                                     |
+-----------------+--------------------------------------------------------------------------------------------------------+-----------------+-----------------------------------------------------------------------------------------------------+
| ::: {#lh:WR6}   | `Physics.WolpertResidual.discreteResidualNatLowerBound_pos_of_asymmetry_or_oneway`                     | ::: {#lh:WR7}   | `Physics.WolpertDecomposition.stopping_time_residual_of_discrete_edge_split`                        |
| `WR6`           |                                                                                                        | `WR7`           |                                                                                                     |
| :::             |                                                                                                        | :::             |                                                                                                     |
+-----------------+--------------------------------------------------------------------------------------------------------+-----------------+-----------------------------------------------------------------------------------------------------+
| ::: {#lh:WR8}   | `Physics.WolpertDecomposition.effective_model_strictly_exceeds_landauer_of_discrete_edge_split`        | ::: {#lh:WR9}   | `Physics.WolpertDecomposition.stopping_time_residual_of_finite_discrete_witness`                    |
| `WR8`           |                                                                                                        | `WR9`           |                                                                                                     |
| :::             |                                                                                                        | :::             |                                                                                                     |
+-----------------+--------------------------------------------------------------------------------------------------------+-----------------+-----------------------------------------------------------------------------------------------------+
| ::: {#lh:WR10}  | `Physics.WolpertDecomposition.effective_model_strictly_exceeds_landauer_of_finite_discrete_witness`    |                 |                                                                                                     |
| `WR10`          |                                                                                                        |                 |                                                                                                     |
| :::             |                                                                                                        |                 |                                                                                                     |
+-----------------+--------------------------------------------------------------------------------------------------------+-----------------+-----------------------------------------------------------------------------------------------------+
|                 |                                                                                                        |                 |                                                                                                     |
...
-   `DecisionQuotient/Physics/ClaimTransport.lean`

-   `DecisionQuotient/Physics/WolpertConstraints.lean`
...
-   `DQ.physical_claim_lifts_from_core_conditional`
...
-   `BF4` $\to$ `DQ.bayes_update_exists_of_nondegenerateBelief`
  ...
  **Paper handle**                                **Status**   **Lean support**
  ...
  `cor:ego-trap`                                  Full         `P.InvariantAgreement.IA17_observer_level_rejection_cascade`

  `cor:exact-identifiability`                     Derived      `DQ.DecisionProblem.minimalSufficient_iff_relevant`, `DQ.DecisionProblem.relevantSet_is_minimal`
  ...
  `cor:gap-minimization-hard`                     Derived      `DP.srank_eq_relevant_card`, `DQ.DecisionProblem.minimalSufficient_iff_relevant`
  ...
  `cor:overmodel-diagnostic-implication`          Derived      `DQ.DecisionProblem.edgeOnComplement_iff_not_sufficient`
  ...
  `cor:posed-anchor-certified-gate`               Full         `CC.AQ8`

  `cor:practice-bounded`                          Full         `DQ.ClaimClosure.tractable_bounded_core`

  `cor:practice-diagnostic`                       Derived      `DP.srank_eq_relevant_card`, `DQ.DecisionProblem.minimalSufficient_iff_relevant`
  ...
  `prop:abstention-frontier`                      Derived      `DQ.ClaimClosure.no_auto_minimize_of_p_neq_conp`
  ...
  `prop:identifiability-convergence`              Derived      `DQ.ClaimClosure.epsilon_admissible_iff_raw_lt_certified_total_core`
  ...
  `prop:mdp-tractable`                            Derived      `DQ.ClaimClosure.process_bridge_failure_witness`
  ...
  `prop:refinement-strengthens`                   Derived      `DQ.ClaimClosure.stochastic_objective_bridge_can_fail_on_sufficiency`

  `prop:retraction-evidence-integrity`            Derived      `DQ.ClaimClosure.subproblem_hardness_lifts_to_full`

  `prop:retraction-no-evidence-violates`          Derived      `DQ.ClaimClosure.subproblem_transfer_as_regime_simulation`
  ...
  `prop:sequential-anchor-refinement`             Derived      `SS.sequential_anchor_sufficient_of_sequential_sufficient`

  `prop:sequential-anchor-tqbf-reduction`         Derived      `SS.SequentialAnchorCheckInstance`, `SS.reduceTQBF_correct_anchor`, `SS.reduceTQBF_to_sequential_anchor_reduction`, `SS.sequential_anchor_check_pspace_hard`

  `prop:sequential-bounded-horizon`               Derived      `DQ.ClaimClosure.physical_crossover_policy_core`

  `prop:sequential-static-relation`               Derived      `DQ.ClaimClosure.physical_crossover_above_cap_core`
  ...
  `prop:static-stochastic-strict`                 Derived      `SS.static_stochastic_strict_separation`

  `prop:static-stochastic-transfer`               Derived      `DQ.ClaimClosure.pose_returns_anchor_query_object`
  ...
  `prop:stochastic-anchor-refinement`             Derived      `SS.stochastic_anchor_sufficient_of_stochastic_sufficient`

  `prop:stochastic-anchor-strict-reduction`       Derived      `SS.StochasticAnchorCheckInstance`, `SS.reduceMAJSAT_correct_anchor_strict`, `SS.reduceMAJSAT_to_stochastic_anchor_reduction`

  `prop:stochastic-bounded-support`               Derived      `DQ.ClaimClosure.posed_anchor_signal_positive_certified_implies_admissible`

  `prop:stochastic-landauer-floor`                Derived      `SS.landauerEnergyFloor_mono_bits`, `SS.landauerEnergyFloor_nonneg`, `SS.thermodynamicCost_eq_landauerEnergyFloorRoom_states`

  `prop:stochastic-potential-duality`             Derived      `SS.stochasticExpectedUtility_eq_neg_expectedActionPotential`, `SS.stochasticExpectedUtility_le_iff_expectedActionPotential_ge`, `SS.utilityFromPotentialDrop_le_iff_nextPotential_ge`

  `prop:stochastic-product-tractable`             Derived      `DQ.ClaimClosure.query_obstruction_boolean_corollary`

  `prop:stochastic-sequential-bridge-fail`        Derived      `DQ.ClaimClosure.posed_anchor_no_competence_no_exact_claim`

  `prop:stochastic-sequential-strict`             Derived      `SS.stochastic_sequential_strict_separation`
...
*Auto summary: mapped 226/226 (full=202, derived=24, unmapped=0).*
  ...
  **Paper handle**                                **Hardness profile**     **Regime tags**                                 **Lean support**
  ...
  `prop:stochastic-landauer-floor`                `cost-growth`            AR,H=cost-growth                                `SS.landauerEnergyFloor_mono_bits`, `SS.landauerEnergyFloor_nonneg`, `SS.thermodynamicCost_eq_landauerEnergyFloorRoom_states`
  ...
  `cor:exact-identifiability`                     `succinct-hard`          H=succinct-hard                                 `DQ.DecisionProblem.minimalSufficient_iff_relevant`, `DQ.DecisionProblem.relevantSet_is_minimal`

  `cor:gap-minimization-hard`                     `succinct-hard`          H=succinct-hard                                 `DP.srank_eq_relevant_card`, `DQ.DecisionProblem.minimalSufficient_iff_relevant`

  `cor:no-auto-minimize`                          `succinct-hard`          H=succinct-hard                                 CC37

  `cor:overmodel-diagnostic-implication`          `succinct-hard`          H=succinct-hard                                 `DQ.DecisionProblem.edgeOnComplement_iff_not_sufficient`

  `cor:practice-diagnostic`                       `succinct-hard`          H=succinct-hard                                 `DP.srank_eq_relevant_card`, `DQ.DecisionProblem.minimalSufficient_iff_relevant`
  ...
  `prop:abstention-frontier`                      `unspecified`            RG                                              `DQ.ClaimClosure.no_auto_minimize_of_p_neq_conp`
  ...
  `prop:identifiability-convergence`              `unspecified`            ID                                              `DQ.ClaimClosure.epsilon_admissible_iff_raw_lt_certified_total_core`
  ...
  `prop:mdp-tractable`                            `unspecified`            FO                                              `DQ.ClaimClosure.process_bridge_failure_witness`
  ...
  `prop:refinement-strengthens`                   `unspecified`            RG                                              `DQ.ClaimClosure.stochastic_objective_bridge_can_fail_on_sufficiency`

  `prop:retraction-evidence-integrity`            `unspecified`            RG                                              `DQ.ClaimClosure.subproblem_hardness_lifts_to_full`

  `prop:retraction-no-evidence-violates`          `unspecified`            RG                                              `DQ.ClaimClosure.subproblem_transfer_as_regime_simulation`
  ...
  `prop:sequential-anchor-refinement`             `unspecified`            PSPACE                                          `SS.sequential_anchor_sufficient_of_sequential_sufficient`

  `prop:sequential-anchor-tqbf-reduction`         `unspecified`            PSPACE                                          `SS.SequentialAnchorCheckInstance`, `SS.reduceTQBF_correct_anchor`, `SS.reduceTQBF_to_sequential_anchor_reduction`, `SS.sequential_anchor_check_pspace_hard`

  `prop:sequential-bounded-horizon`               `unspecified`            BH                                              `DQ.ClaimClosure.physical_crossover_policy_core`

  `prop:sequential-static-relation`               `unspecified`            DET,T=1                                         `DQ.ClaimClosure.physical_crossover_above_cap_core`
  ...
  `prop:static-stochastic-strict`                 `unspecified`            P $\neq$ coNP                                   `SS.static_stochastic_strict_separation`

  `prop:static-stochastic-transfer`               `unspecified`            PD                                              `DQ.ClaimClosure.pose_returns_anchor_query_object`

  `prop:steps-run-scalar`                         `unspecified`            AR                                              IC42, IC43

  `prop:stochastic-anchor-refinement`             `unspecified`            PP                                              `SS.stochastic_anchor_sufficient_of_stochastic_sufficient`

  `prop:stochastic-anchor-strict-reduction`       `unspecified`            PP                                              `SS.StochasticAnchorCheckInstance`, `SS.reduceMAJSAT_correct_anchor_strict`, `SS.reduceMAJSAT_to_stochastic_anchor_reduction`

  `prop:stochastic-bounded-support`               `unspecified`            BS                                              `DQ.ClaimClosure.posed_anchor_signal_positive_certified_implies_admissible`

  `prop:stochastic-potential-duality`             `unspecified`            PP                                              `SS.stochasticExpectedUtility_eq_neg_expectedActionPotential`, `SS.stochasticExpectedUtility_le_iff_expectedActionPotential_ge`, `SS.utilityFromPotentialDrop_le_iff_nextPotential_ge`

  `prop:stochastic-product-tractable`             `unspecified`            PD                                              `DQ.ClaimClosure.query_obstruction_boolean_corollary`

  `prop:stochastic-sequential-bridge-fail`        `unspecified`            CE                                              `DQ.ClaimClosure.posed_anchor_no_competence_no_exact_claim`

  `prop:stochastic-sequential-strict`             `unspecified`            P $\neq$ PP                                     `SS.stochastic_sequential_strict_separation`
