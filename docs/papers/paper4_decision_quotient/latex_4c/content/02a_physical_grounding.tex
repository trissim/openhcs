...
\end{enumerate}
\leanmeta{\LHrng{WC}{1}{3}, \LH{WM1}, \LHrng{WM}{3}{4}, \LHrng{WR}{1}{3}, \LH{WR6}.}
...
\leanmeta{\LH{BA10}, \LHrng{WC}{2}{3}, \LH{WM1}, \LHrng{WM}{3}{4}, \LHrng{WR}{2}{3}, \LH{WR6}}
...
\item \textbf{Observer level (IA13--IA18):} Observers are made of atoms and
  ...
  By the time ego enters, agreement is already forced.
\end{enumerate}
\leanmeta{\LH{IA2}, \LH{IA5}, \LH{IA9}, \LH{IA13}, \LHrng{IA}{17}{18}}

\begin{corollary}[The Ego Trap]\label{cor:ego-trap}
