...
\leanmeta{\LH{CT4}, \LH{CT6}, \LH{HD1}, \LHrng{HD}{4}{5}.}
...
\leanmeta{\LH{DT13}, \LH{DT16}, \LHrng{CV}{17}{18}, \LH{CC76}.}
...
\leanmeta{\LH{IC7}, \LH{IC18}, \LH{IC25}, \LHrng{CC}{71}{73}, \LHrng{CC}{81}{82}, \LH{CC84}, \LH{DP1}.}
\end{remark}
...
\begin{proof}
By \LH{DP1} together with \LH{SK1}, sufficiency of size $\le k$ aligns with a relevance-cardinality bound $\le k$ in the Boolean-coordinate model.
\end{proof}
