...
\]
This is the sequential state-based certification predicate used throughout the paper.
\end{definition}
...
\paragraph{Scope and research direction.}
...
\leanmetapending{\LHrng{DC}{49}{50}}
...
\begin{proof}
With this definition, sequential sufficiency is just sufficiency of the underlying one-step optimizer map on the state space. The static minimal-set/relevance equivalence therefore transports directly to the sequential setting.
\end{proof}
...
\leanmetapending{\LH{DC46}, \LH{DC66}, \LH{DC74}}
...
\leanmetapending{\LHrng{DC}{28}{29}, \LH{DC44}}
...
\leanmetapending{\LH{DC46}, \LH{DC48}}
...
\leanmetapending{\LHrng{DC}{66}{69}, \LHrng{DC}{74}{76}}
...
\leanmetapending{\LH{DQ12}, \LH{DQ14}, \LH{DQ45}}
