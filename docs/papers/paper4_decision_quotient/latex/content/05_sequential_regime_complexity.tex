...
There are two closely related readings of this definition. The formal reading used in the paper and artifact is the state-based predicate above. Its intended interpretation is policy-level: hidden information may be irrelevant at time zero and still become relevant later because it changes future contingent choices. The sequential results are stated for the induced state-based optimizer predicate formalized in the artifact; the policy-level reading is motivational rather than the formal theorem object.
