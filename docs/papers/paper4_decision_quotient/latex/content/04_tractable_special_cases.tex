...
\end{tabularx}
\par\smallskip
\textbf{Tractability map.} Each restriction above removes a structural hardness source. Formal definitions for all cases are retained in the subsections below.
\endgroup
