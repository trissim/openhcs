...
\midrule
MINIMUM-SUFFICIENT-SET & \parbox[c]{0.20\linewidth}{apparent $\exists I\,\forall$\pair check} & smallest sufficient support & collapses to relevance containment in the static regime \\
\midrule
