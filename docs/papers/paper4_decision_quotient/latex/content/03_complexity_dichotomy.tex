...
\begin{tabularx}{\linewidth}{@{}>{\raggedright\arraybackslash}m{0.19\linewidth}>{\raggedright\arraybackslash}m{0.19\linewidth}>{\raggedright\arraybackslash}X>{\raggedright\arraybackslash}m{0.18\linewidth}@{}}
\toprule
...
\bottomrule
\end{tabularx}
\caption{Boundary summary. The tractable-hard contrast is controlled jointly by encoding and by the size of the true sufficient support.}
\label{tab:dichotomy-boundary}
\end{table}

\leanmetapending{\LH{DQ26}, \LHrng{DQ}{29}{30}}
\begin{theorem}[Encoding-Sensitive Contrast]\label{thm:dichotomy}
...
\leanmetapending{\LH{DQ27}, \LH{DQ30}}
...
\subsection{Cross-Model Contrast}

\leanmetapending{\LH{DQ3}, \LH{DQ26}}
\begin{corollary}[Cross-Model Contrast for Exact Certification]\label{cor:phase-transition}
Across the explicit-state and succinct encodings of Section~\ref{sec:encoding}, exact certification exhibits the following contrast:
\begin{itemize}
...
\begin{remark}[Asymptotic Tightness Within Each Encoding]
