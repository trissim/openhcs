...
\begin{tabularx}{\linewidth}{@{}>{\RaggedRight\arraybackslash}m{0.22\linewidth}>{\RaggedRight\arraybackslash}X>{\RaggedRight\arraybackslash}X>{\RaggedRight\arraybackslash}X@{}}
\toprule
\textbf{Regime / predicate} & \textbf{Base query} & \textbf{Minimum} & \textbf{Anchor} \\
\midrule
