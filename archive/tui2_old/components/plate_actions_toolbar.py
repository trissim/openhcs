...
from prompt_toolkit.widgets import Button # Using prompt_toolkit Button directly or FramedButton
...
class PlateActionsToolbar:
    ...
    def __init__(self,
        ...
        self.edit_config_button: Optional[FramedButton] = None # Renamed from 'edit_button' for clarity
        self.init_button: Optional[FramedButton] = None
        self.compile_button: Optional[FramedButton] = None
        self.run_button: Optional[FramedButton] = None
    ...
    def _create_buttons(self):
        ...
        self.edit_config_button = FramedButton(
        ...
        self.compile_button = FramedButton(
            "Compile",
            handler=lambda: get_app().create_background_task(
    ...
    def _build_container(self) -> VSplit:
        ...
        # Filter out None if any button failed to initialize (should not happen with FramedButton)
