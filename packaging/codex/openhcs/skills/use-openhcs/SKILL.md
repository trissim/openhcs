...
4. Always call `openhcs_list_capabilities`. Its current `surface_profile`, workflow groups, target contexts, side effects, and security metadata—not a remembered tool list—decide whether to use a UI-visible or exposed headless route.
