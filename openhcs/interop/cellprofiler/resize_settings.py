...
class ResizeMethod(Enum):
    """CellProfiler Resize method serialized for absorbed functions."""

    BY_FACTOR = "by_factor"
    TO_SIZE = "to_size"


class ResizeInterpolationMethod(Enum):
    """CellProfiler Resize interpolation method serialized for absorbed functions."""
...
RESIZE_WIDTH_SETTING = SettingNameFamily(
    "Width of the final image",
    aliases=("Width (x) of the final image",),
)
RESIZE_HEIGHT_SETTING = SettingNameFamily(
