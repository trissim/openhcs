...
def _materialize_single_channel_results(data: List[CellCountResult], path: str, filemanager) -> str:
    ...
    # Summary JSON
    json_path = path.replace('.pkl', '_cell_counts.json')
    ...
    csv_path = path.replace('.pkl', '_cell_details.csv')
    rows = []
...
def _materialize_multi_channel_results(data: List[MultiChannelResult], path: str, filemanager) -> str:
    ...
    # Summary JSON
    json_path = path.replace('.pkl', '_multi_channel_analysis.json')
    ...
    # CSV for detailed analysis
    csv_path = path.replace('.pkl', '_colocalization_details.csv')
    rows = []
