...
# Import alvahmm from its optional dependency without granting it root logging.
...
ALVA_AVAILABLE = bool(alva_MCMC and alva_branch)


def materialize_trace_visualizations(
    data: List[np.ndarray], path: str, filemanager, backend: str
) -> str:
