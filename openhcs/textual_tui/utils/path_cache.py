"""
Aggressive path caching system for FileManagerBrowser.

Persists last used paths across application runs for improved UX.
"""
...
class PathCacheKey(Enum):
    """Cache keys for different browser contexts."""
...
class PathCache:
    """Aggressive path caching with persistent storage."""
    ...
    def _load_cache(self) -> None:
        """Load cache from disk - aggressive error handling."""
        try:
    ...
    def _save_cache(self) -> None:
        """Save cache to disk - aggressive error handling."""
        try:
