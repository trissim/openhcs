...
class EventRecorder(QObject):
    ...
    def generate_test_code(self, output_path: Optional[Path] = None) -> str:
        ...
        imports = [
            ...
            "from openhcs.pyqt_gui.services.function_catalog_projection import ZMQFunctionCatalogProjectionService",
        ...
        test_func = [
            ...
            "    function_catalog = ZMQFunctionCatalogProjectionService(lambda: runtime_context.ui_config.zmq)",
            "    main_window = OpenHCSMainWindow(runtime_context=runtime_context, function_catalog_projection=function_catalog)",
