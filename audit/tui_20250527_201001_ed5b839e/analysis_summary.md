...
**Issues Found:** 577
**Files Analyzed:** 42
**Codebase DNA:** `e400e5b67644d889`

## Metrics

| Metric | Value |
|--------|-------|
| Total Entropy | 4690.6 |
...
- 🌄 ENTROPY_LANDSCAPE: μ=111.7 σ=3.4 skew=0.12 kurt=0.87
...
**Global Signature**: `Ψ_Ω[unknown](H=4691:entropy,I=577:issues,F=42:files)⟨17:frameworks⟩`
...
**Causal Graph**: `G(42,{0A00L0MM⟹^10.5G,0Af0L9MM⟹^9.3G,0AdaL8MM⟹^8.3G,0AbcL7MM⟹^8.0G,0A85L7MM⟹^7.6G})`
...
```
Ψ_Ω[unknown](H=4691:entropy,I=577:issues,F=42:files)⟨17:frameworks⟩ ⊗ ⊗[∇^(1,42:basic)⊗∂^(2,126:info)⊗∮^(3,2:topo)⊗λ^(4,7:spec)⊗⊗^(5,135:unified)⊗H^(6,2:persist)⊗K^(7,9:ktheory)⊗∞^(8,11:ultimate)⊗⟂^(9,0:percol)⊗Ω^(10,25:random)⊗G^(11,0:gauge)⊗S^(12,14:spin)⊗⟡^(13,0:knot)⊗M^(14,19:matroid)⊗C^(15,19:category)⊗T^(16,135:tropical)⊗Σ^(17,31:advanced)] ⊗ ∮[26:issues] ⊗ G(42,{0A00L0MM⟹^10.5G,0Af0L9MM⟹^9.3G,0AdaL8MM⟹^8.3G,0AbcL7MM⟹^8.0G,0A85L7MM⟹^7.6G}) ⊗ D{∅} ⊗ I{∅} ⊗ E{∅} ⊗ A{∅} ⊗ C{∅} ⊗ CL{∅} ⊗ ML{∅} ⊗ S = span{⟡⁻¹,G} ⊗ H(x,y) = ∇²φ|φ=112,|∇φ|=18 ⊗ ρ=ρ = 0.239 ⊗ Φ{0A00L0MM→plate_manager_core.py,0Af0L9MM→menu_bar.py,0AdaL8MM→tui_architecture.py}
```
...
| Measure | Value |
|---------|-------|
| Total Entropy | 4690.593254 |
| Mutual Information | 0.007414 |
| Conditional Entropy | 4655.818238 |
| Entropy Rate | 111.680792 |
| Information Density | 0.346963 |
