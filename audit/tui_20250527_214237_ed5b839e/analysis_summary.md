...
**Issues Found:** 741
**Files Analyzed:** 42
**Codebase DNA:** `079789c2c5ce4f84`

## Metrics

| Metric | Value |
|--------|-------|
| Total Entropy | 4704.8 |
...
- 🌄 ENTROPY_LANDSCAPE: μ=112.0 σ=3.5 skew=0.04 kurt=0.95
...
**Global Signature**: `Ψ_Ω[unknown](H=4705:entropy,I=741:issues,F=42:files)⟨17:frameworks⟩`
...
**Causal Graph**: `G(42,{0A00L0MM⟹^10.7G,0Af0L9MM⟹^9.6G,0AdaL8MM⟹^8.5G,0AbcL8MM⟹^8.2G,0A85L7MM⟹^7.7G})`
...
| Measure | Value |
|---------|-------|
| Total Entropy | 4704.837392 |
| Mutual Information | 0.007972 |
| Conditional Entropy | 4667.331007 |
| Entropy Rate | 112.019938 |
| Information Density | 0.324920 |

## Semantic Analysis

### Framework Synthesis
- **Total Frameworks**: 17
- **Weighted Issue Score**: 1195.1
...
| commands.py | 8.18 | 1.00 | HIGH | HIGH_COMPLEXITY: Use gauge theory transformations, KNOT_THEORY: Untangle dependency crossings |
