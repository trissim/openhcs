...
def run_vina(
    ...
    try:
        ...
        if result.returncode != 0:
            return VinaResult(
                pdb_code=pdb_code, best_affinity=0, best_rmsd_lb=0,
                best_rmsd_ub=0, n_modes=0, wall_time_s=wall_time,
        ...
        return VinaResult(
            pdb_code=pdb_code, best_affinity=0, best_rmsd_lb=0,
            best_rmsd_ub=0, n_modes=0, wall_time_s=600,
            success=False, error="Timeout"
        )
    except FileNotFoundError:
        return VinaResult(
            pdb_code=pdb_code, best_affinity=0, best_rmsd_lb=0,
            best_rmsd_ub=0, n_modes=0, wall_time_s=0,
            success=False, error="Vina binary not found"
        )
